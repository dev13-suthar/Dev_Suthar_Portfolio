  ...
  return (
    <Box p={"0.85rem"} mt={"0.6rem"} ref={projectRef}>
      ...
      <Box display={"flex"} gap={"2rem"} mt={"0.5rem"} p={"1.1rem"} justifyContent={"center"} flexWrap={"wrap"}>
        <CarddProject img={pizza} Title={"React Pizza Co."} body={"Pizza Delivery App Made With React,Redux,Tailwind and Used API for Data"} to={"https://github.com/dev13-suthar/React_Pizaa_App.git"}/>
